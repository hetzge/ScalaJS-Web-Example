...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record5<Integer, String, String, String, String> {
	...
	private static final long serialVersionUID = -1380647732;
	...
	/**
	 * Setter for <code>test.user.profileimage</code>.
	 */
	...
	/**
	 * Getter for <code>test.user.profileimage</code>.
	 */
	 ...
	 */
	public UserRecord(Integer id, String username, String email, String password, String profileimage) {
		super(User.USER);
